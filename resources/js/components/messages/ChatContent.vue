...
<template>
    <div class="chat-body hide-scrollbar flex-1 h-100">
        <div class="chat-body-inner chat-container">
            <div ref="messages " class="py-6 py-lg-12 messages" id="chat-body">
                        ...
                        <div class="message-body">
                            <div class="message-content">
                                ...
                                <div class="message-gallery"
                                    ...
                                    <div class="row gx-3">
                                        <div class="col">
                                            <img class="img-fluid rounded" v-bind:src="'/storage/' + message.body.file_path"
...
export default {
    ...
    mounted() {
        ...
        if (this.conversation) {
            ...
            // التمرير إلى أسفل الصفحة عند تحميل الرسائل
            this.$nextTick(() => {
                this.scrollToBottom();
            });
