<template>
    <div class="container py-8">
        ...
        <div class="mb-6">
            <form action="#">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control form-control-lg ps-0" placeholder="Search messages"
        ...
        <div class="card-list" id="chat-list">
            <a v-for="conversation in $root.conversations" v-bind:key="conversation.id" v-bind:href="'#' + conversation.id"
